...
// Handles both a raw numeric cell (xlsx/xls) and a currency-formatted string
// cell (seen from Google Sheets' CSV export, e.g. "€ 1,500.00") - strips
// everything but digits/dot/minus before parsing, so thousands-separator
// commas and currency symbols never turn a real price into NaN.
...
module.exports = {
  norm, normHeader, findCol, parseSerials, parseQtyAvailable, parsePrice, deriveTechFields,
};
